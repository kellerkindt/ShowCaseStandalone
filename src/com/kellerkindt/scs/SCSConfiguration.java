...
public class SCSConfiguration extends Configuration {
    ...
    public Collection<String> getBlockListBlocks () {
        ...
        return getForced(KEY_BLOCKLIST_BLOCKS, Arrays.asList(
                ...
                Material.SPRUCE_LEAVES.toString(),
                Material.COBWEB.toString(),
                Material.GRASS.toString(),
                Material.GRASS_BLOCK.toString(),
                Material.GRASS_PATH.toString(),
                Material.TALL_GRASS.toString(),
                Material.SEAGRASS.toString(),
                Material.TALL_SEAGRASS.toString(),
                ...
                // TODO Material.DIODE.toString(),
                // TODO Material.DIODE_BLOCK_ON.toString(),
                // TODO Material.DIODE_BLOCK_OFF.toString(),
                ...
                Material.ACACIA_FENCE_GATE.toString(),
                Material.BIRCH_FENCE_GATE.toString(),
                Material.JUNGLE_FENCE_GATE.toString(),
                Material.OAK_FENCE_GATE.toString(),
                Material.SPRUCE_FENCE_GATE.toString(),
                Material.DARK_OAK_FENCE_GATE.toString(),
